...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        namelist.add("The Little Match Girl (ft. Enlia)");
        //5个艺术家名
        ...
        String url6="https://files.freemusicarchive.org/storage-freemusicarchive-org/tracks/YcKcasolCFrNfZVJtr5YaYZcS3eCv3waBC9XrTZx.mp3";
